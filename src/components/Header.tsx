...
const Header: React.FC<HeaderProps> = ({ pageTitle }) => (
  <header className="relative flex justify-between pt-1 pb-2 px-1 min-h-[60px]">
    <div className="order-first w-full pt-4 text-xl font-semibold leading-snug text-left">
      <h1 className="pd-2 text-3xl font-semibold leading-snug text-left">{pageTitle}</h1>
      <hr className="max-w-[970px] h-[4px] border-0 rounded-full bg-gradient-to-r from-red-900 to-sky-50 via-blue-400" />
    </div>
